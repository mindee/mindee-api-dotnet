...
namespace Mindee.UnitTests.Product.Fr.IdCard
{
    ...
    public class IdCardV1Test
    {
        ...
        {
            var response = await GetPrediction("complete");
            var expected = File.ReadAllText("Resources/products/idcard_fr/response_v1/summary_page0.rst");
        ...
        {
            string fileName = $"Resources/products/idcard_fr/response_v1/{name}.json";
