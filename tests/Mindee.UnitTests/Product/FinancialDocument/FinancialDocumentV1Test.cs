...
namespace Mindee.UnitTests.Product.FinancialDocument
{
    ...
    public class FinancialDocumentV1Test
    {
        ...
        {
            var mindeeAPi = UnitTestBase.GetMindeeApi("Resources/financial_document/response_v1/complete_invoice.json");
        ...
        {
            var mindeeAPi = UnitTestBase.GetMindeeApi("Resources/financial_document/response_v1/complete_receipt.json");
