...
namespace Mindee.UnitTests.V1.Product.Fr.IdCard
{
    ...
    public class IdCardV2Test
    {
        ...
        public async Task Predict_CheckSummary()
        {
            ...
            var expected = File.ReadAllText(Constants.V1ProductPath + "idcard_fr/response_v2/summary_full.rst");
        ...
        {
            var response = await GetPrediction("complete");
            var expected = File.ReadAllText(Constants.V1ProductPath + "idcard_fr/response_v2/summary_page0.rst");
        ...
        {
            var fileName = Constants.V1ResourcePath + $"products/idcard_fr/response_v2/{name}.json";
