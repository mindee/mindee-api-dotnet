...
namespace Mindee.UnitTests.V1.Product.Fr.IdCard
{
    ...
    public class IdCardV1Test
    {
        ...
        public async Task Predict_CheckSummary()
        {
            ...
            var expected = File.ReadAllText(Constants.V1ProductPath + "idcard_fr/response_v1/summary_full.rst");
        ...
        {
            var response = await GetPrediction("complete");
            var expected = File.ReadAllText(Constants.V1ProductPath + "idcard_fr/response_v1/summary_page0.rst");
        ...
        {
            var fileName = Constants.V1ResourcePath + $"products/idcard_fr/response_v1/{name}.json";
