...
namespace Mindee.UnitTests.V1.Product.Cropper
{
    ...
    public class CropperV1Test
    {
        ...
        public async Task Predict_CheckSummary()
        {
            ...
            var expected = File.ReadAllText(Constants.V1ProductPath + "cropper/response_v1/summary_full.rst");
        ...
        {
            var response = await GetPrediction("complete");
            var expected = File.ReadAllText(Constants.V1ProductPath + "cropper/response_v1/summary_page0.rst");
        ...
        {
            var fileName = Constants.V1ResourcePath + $"products/cropper/response_v1/{name}.json";
