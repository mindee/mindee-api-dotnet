...
namespace Mindee.UnitTests.V1.Product.Receipt
{
    ...
    public class ReceiptV4Test
    {
        ...
        public async Task Predict_CheckSummary()
        {
            ...
            var expected = File.ReadAllText(Constants.V1ProductPath + "expense_receipts/response_v4/summary_full.rst");
            Assert.Equal(
                expected,
        ...
        {
            var response = await GetPrediction();
            var expected = File.ReadAllText(Constants.V1ProductPath + "expense_receipts/response_v4/summary_page0.rst");
            Assert.Equal(
                expected,
        ...
        {
            const string fileName = Constants.V1ResourcePath + "extras/cropper/complete.json";
        ...
        {
            const string fileName = Constants.V1ProductPath + "expense_receipts/response_v4/complete.json";
            var mindeeAPi = UnitTestBase.GetMindeeApi(fileName);
