...
namespace Mindee.UnitTests.V1.Product.Us.BankCheck
{
    ...
    public class BankCheckV1Test
    {
        ...
        public async Task Predict_CheckSummary()
        {
            ...
            var expected = File.ReadAllText(Constants.V1ProductPath + "bank_check/response_v1/summary_full.rst");
        ...
        {
            var response = await GetPrediction("complete");
            var expected = File.ReadAllText(Constants.V1ProductPath + "bank_check/response_v1/summary_page0.rst");
        ...
        {
            var fileName = Constants.V1ResourcePath + $"products/bank_check/response_v1/{name}.json";
