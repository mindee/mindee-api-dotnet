    ...
    public class AsyncPredictResponseTest
    {
        ...
        public async Task WhenAsyncPost_ReturnsErrorForbidden_MustBeDeserialized()
        {
            var response = await JsonSerializer.DeserializeAsync<AsyncPredictResponse<InvoiceSplitterV1>>(
                new FileInfo(Constants.V1ResourcePath + "async/post_fail_forbidden.json").OpenRead());
        ...
        {
            var response = await JsonSerializer.DeserializeAsync<AsyncPredictResponse<InvoiceSplitterV1>>(
                new FileInfo(Constants.V1ResourcePath + "async/post_success.json").OpenRead());
        ...
        {
            var response = await JsonSerializer.DeserializeAsync<AsyncPredictResponse<InvoiceSplitterV1>>(
                new FileInfo(Constants.V1ResourcePath + "async/get_completed.json").OpenRead());
        ...
        {
            var response = await JsonSerializer.DeserializeAsync<AsyncPredictResponse<InvoiceSplitterV1>>(
                new FileInfo(Constants.V1ResourcePath + "async/get_failed_job_error.json").OpenRead());
