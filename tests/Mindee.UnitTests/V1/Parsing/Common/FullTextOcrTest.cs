...
namespace Mindee.UnitTests.V1.Parsing.Common
{
    ...
    public class FullTextOcrTest
    {
        ...
        {
            var json = File.ReadAllText(Constants.V1ResourcePath + "extras/full_text_ocr/complete.json");
        ...
        {
            var expectedText = File.ReadAllLines(Constants.V1ResourcePath + "extras/full_text_ocr/full_text_ocr.txt");
            var pages = LoadPages();
