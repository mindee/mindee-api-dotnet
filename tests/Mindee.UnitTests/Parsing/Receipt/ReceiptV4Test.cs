...
namespace Mindee.UnitTests.Parsing.Receipt
{
    ...
    public class ReceiptV4Test
    {
        ...
        public async Task Predict_WithCropping_MustSuccess()
        {
            ...
            var response = await mindeeAPi.PredictAsync<ReceiptV4Inference>(ParsingTestBase.GetFakePredictParameter());
        ...
        private static async Task<PredictResponse<ReceiptV4Inference>> GetPrediction()
        {
            ...
            var mindeeAPi = ParsingTestBase.GetMindeeApi(fileName);
            return await mindeeAPi.PredictAsync<ReceiptV4Inference>(ParsingTestBase.GetFakePredictParameter());
        }
    }
}
