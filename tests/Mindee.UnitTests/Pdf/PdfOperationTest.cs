    ...
    public class PdfOperationTest
    {
        ...
        public void Split_Wants1Page_MustGetOnly1Page()
        {
            var splitQuery = new SplitQuery(
                File.ReadAllBytes(Constants.ResourcePath + "file_types/pdf/multipage.pdf"),
        ...
        public void Split_Wants2Pages_MustGet2Pages()
        {
            var splitQuery = new SplitQuery(File.ReadAllBytes(
                    Constants.ResourcePath + "file_types/pdf/multipage.pdf"),
        ...
        public void Split_WantsTooManyPages_MustFail()
        {
            ...
            var splitQuery = new SplitQuery(File.ReadAllBytes(
                Constants.ResourcePath + "file_types/pdf/multipage.pdf"), pageOptions);
        ...
        {
            var splitQuery = new SplitQuery(File.ReadAllBytes(
                    Constants.ResourcePath + "file_types/receipt.jpga"),
        ...
        {
            var splitQuery = new SplitQuery(
                File.ReadAllBytes(Constants.ResourcePath + "file_types/pdf/multipage_cut-2.pdf")
                , new PageOptions(
                    new short[] { 0 }
                    , PageOptionsOperation.Remove
                    , 5));
