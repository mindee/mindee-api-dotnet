...
namespace Mindee.UnitTests.Domain.Pdf
{
    public class PdfOperationTest
    {
        ...
        [Fact]
        [Trait("Category", "Pdf operations")]
        public async Task Split_Wants2Page_MustGet2Page()
        {
        ...
        [Fact]
        [Trait("Category", "Pdf operations")]
        public async Task Split_ShouldCutTheFirstAndThe2LastPages_MustSuccess()
        {
        ...
        [Fact]
        [Trait("Category", "Pdf operations")]
        public async Task Split_ShouldRemovePages_MustSuccess()
        {
        ...
        [Fact]
        [Trait("Category", "Pdf operations")]
        public async Task Split_ShouldNotRemovePagesBecauseMinPagesAreNotMet()
        {
            var splitQuery = new SplitQuery(
                File.OpenRead("Resources/pdf/multipage_cut-2.pdf")
                , new PageOptions(
                    new short[] { 1 }
                    , PageOptionsOperation.Remove
                    , 5));
