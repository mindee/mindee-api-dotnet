...
namespace Mindee.IntegrationTests
{
    ...
    public class DependencyInjectionTest : IAsyncLifetime
    {
        ...
        {
            var clientV1 = _services.GetRequiredService<ClientV1>();
            Assert.NotNull(clientV1);
            var clientV2 = _services.GetRequiredService<ClientV2>();
        ...
        {
            var instance1ClientV1 = _services.GetRequiredService<ClientV1>();
            ...
            var instance2ClientV1 = _services.GetRequiredService<ClientV1>();
